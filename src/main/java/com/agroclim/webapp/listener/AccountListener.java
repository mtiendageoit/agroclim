package com.agroclim.webapp.listener;
...
public class AccountListener {
  ...
  public void onRegistrationSuccessEvent(RegistrationSuccessEvent event) throws Exception {
    ...
    String subject = "Bienvenido a Agroclim";

    String message = "Estimado usuario,\n\n";
    message += "¡Bienvenido a Agroclim!\n\n";
    message += "Para acceder a nuestros servicios, primero debes verificar tu correo electrónico visitando el siguiente enlace: \n";
    message += link;
    message += "\n\nEn Agroclim, nos esforzamos por ofrecerte los mejores servicios de análisis para la agricultura.";
  ...
  public void onResetPasswordEvent(ResetPasswordEvent event) throws Exception {
    ...
    String message = "Estimado usuario,\n\n";
    message += "Hemos recibido una solicitud para recuperar la contraseña de tu cuenta en Agroclim.\n\n";
  ...
  private void sendMail(String to, String subject, String text) throws Exception {
    ...
    message.setFrom(new InternetAddress(config.getAppMailSender(), "Agroclim"));
    message.setTo(to);
